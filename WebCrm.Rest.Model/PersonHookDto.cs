...
namespace WebCrm.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonHookDto : BaseObject, IEquatable<PersonHookDto>, IValidatableObject
    {
        /// <summary>
        /// Defines Filter
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonHookDto" /> class.
        /// </summary>
        [JsonConstructor]
        protected PersonHookDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonHookDto" /> class.
        /// </summary>
        ...
        public PersonHookDto(List<FilterEnum> Filter = default(List<FilterEnum>), DateTime? CreatedAt = default(DateTime?), string CreatedBy = default(string), EventTypeEnum? EventType = default(EventTypeEnum?), long? Id = default(long?), bool? IsEnabled = default(bool?), string TargetUrl = default(string), DateTime? UpdatedAt = default(DateTime?), string UpdatedBy = default(string))
        {
            // to ensure "Filter" is required (not null)
            if (Filter == null)
            {
                throw new InvalidDataException("Filter is a required property for PersonHookDto and cannot be null");
            }
            else
            {
                this.Filter = Filter;
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for PersonHookDto and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (IsEnabled == null)
            {
                throw new InvalidDataException("IsEnabled is a required property for PersonHookDto and cannot be null");
            }
            else
            {
            ...
            if (TargetUrl == null)
            {
                throw new InvalidDataException("TargetUrl is a required property for PersonHookDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PersonHookDto);
        }

        /// <summary>
        /// Returns true if PersonHookDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonHookDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonHookDto input)
        {
            if (input == null)
                return false;
