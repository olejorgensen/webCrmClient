...
namespace WebCrm.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelationHookDto : BaseObject, IEquatable<RelationHookDto>, IValidatableObject
    {
        /// <summary>
        /// Defines Filter
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationHookDto" /> class.
        /// </summary>
        [JsonConstructor]
        protected RelationHookDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationHookDto" /> class.
        /// </summary>
        ...
        public RelationHookDto(List<FilterEnum> Filter = default(List<FilterEnum>), DateTime? CreatedAt = default(DateTime?), string CreatedBy = default(string), EventTypeEnum? EventType = default(EventTypeEnum?), long? Id = default(long?), bool? IsEnabled = default(bool?), string TargetUrl = default(string), DateTime? UpdatedAt = default(DateTime?), string UpdatedBy = default(string))
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for RelationHookDto and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (IsEnabled == null)
            {
                throw new InvalidDataException("IsEnabled is a required property for RelationHookDto and cannot be null");
            }
            else
            {
            ...
            if (TargetUrl == null)
            {
                throw new InvalidDataException("TargetUrl is a required property for RelationHookDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RelationHookDto);
        }

        /// <summary>
        /// Returns true if RelationHookDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationHookDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationHookDto input)
        {
            if (input == null)
                return false;
